...
{
    public partial class NuevaVenta : DevExpress.XtraEditors.XtraUserControl
    {
        Inmueble_BL inmueble_BL = new Inmueble_BL();
        private static NuevaVenta _instance;
        public static NuevaVenta Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new NuevaVenta();
                return _instance;
